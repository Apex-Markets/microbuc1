        ...
        <div className="relative z-10 flex flex-col justify-center px-12 xl:px-20">
          ...
          >
            <Link to="/" className="inline-flex items-center gap-2 mb-12">
              ...
              <span className="text-2xl font-bold text-foreground">Micropay</span>
            </Link>
            
            <h1 className="text-4xl xl:text-5xl font-bold text-foreground leading-tight mb-6">
              Turn spare change into
              <span className="block gradient-text">debt freedom</span>
            </h1>
            
            <p className="text-lg text-muted-foreground max-w-md mb-8">
              Every round-up gets you closer to being debt-free. Watch your progress grow automatically with every purchase.
            </p>
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    className="pl-11 h-12 bg-secondary/50 border-border/50 focus:border-primary/50 focus:bg-secondary/80 transition-all"
                    required
                  />
                </div>
              </div>
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    className="pl-11 pr-11 h-12 bg-secondary/50 border-border/50 focus:border-primary/50 focus:bg-secondary/80 transition-all"
                    required
                  />
                  <button
                    type="button"
